...
NumArray.prototype.build = function (nums) {
    ...
    for (var i = n; i < n * 2; i++) {
        ...
        console.log('segTree:::', this.segTree);
        j++;
    }
    for (i = n - 1; i > 0; i--) {
        console.log(`this.segTree[${i} * 2]:::`, this.segTree[i * 2])
        console.log(`this.segTree[${i} * 2 + 1]:::`, this.segTree[i * 2 + 1])
...
const numArray = new NumArray([1, 2, 5, 6, 7, 9]);
